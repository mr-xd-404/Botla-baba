...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage(`๛আমি ๛➣𓆩𝐁𝐀𝐏𝐏𝐀᭄𓆪‣𒁍 বস এর বট থাকতে কিছুই লুকাতে পারবি না 🥺 ,@${e} এই হাউয়ার পোলায় মাত্র \n\n ( \"${m.msgBody}\" ) \n\n এই টেক্সট টা রিমুভ দিছে😁সবাই দেখে নেও🐸😁 `, u); {
			let t = 0,
				s = {
					body: `আমি ๛➣𓆩𝐁𝐀𝐏𝐏𝐀᭄𓆪‣𒁍 বস এর বট থাকতে কিছুই লুকাতে পারবি না @${e} এই হালায় এই মাত্র এইডা রিমুভ দিছে🍁🗿 সবাই দেখে নেও🐸😁${""!=m.msgBody?`\n\nContent: ${m.msgBody}`:""}`,
					attachment: [],
					mentions: {
						tag: e,
						id: l
